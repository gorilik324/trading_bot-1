...
urlpatterns = [
    ...
    path('strategy_result/result/', strategy_result, name='strategy_result'),
    path('arbitrage/', views.arbitrage_view, name='arbitrage'),
    # Add URL pattern for arbitrage_result view
    path('arbitrage_result/', arbitrage_result, name='arbitrage_result'),
    path('', StrategyListView.as_view(), name='strategies'),
